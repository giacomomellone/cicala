...
**Omron B3F-4050** is selected for both controls. The projected 3.8 mm square plunger matches **B32-1200 (ivory, 9 × 9 mm)** and **B32-1320 (orange, 12 × 12 mm)**. The caps are 5.5 mm high and both reach 10.0 ±0.4 mm above the PCB when seated. The B3F drawing specifies a 12 × 12 mm body, 7.3 ±0.2 mm projected-plunger height, 1.27 ±0.49 N operating force and 0.3 +0.2/−0.1 mm pretravel. The 1.27 N B3F-4000 family rating is three million operations; this is the component rating, not measured device life. [Omron B3F](https://omronfs.omron.com/en_US/ecb/products/pdf/en-b3f.pdf), [Omron B32](https://omronfs.omron.com/en_US/ecb/products/pdf/en-b32.pdf).

The local centered footprint follows the top-view drilling diagram: four 1.2 mm PTH holes on a 12.5 × 5 mm grid and two 1.8 mm NPTH positioning holes, 9 mm apart. Logical pin 1 joins the top terminal pair, pin 2 the bottom pair; the PCB also connects each duplicate pair in copper. These logical numbers intentionally collapse the manufacturer's four physical terminal numbers into the existing two-pin switch symbol. The 2.4 × 2.0 mm oval lands provide at least 0.4 mm nominal annular copper. Specify finished hole sizes; the manufacturer drawing calls for ±0.05 mm hole tolerances. Ask the fabricator to confirm these at order.

The 22 kΩ pull-ups draw about 150 µA at 3.3 V. This exceeds Omron's reference minimum applicable load of 10 µA at 1 V, though it is below the general 1 mA rated-load range. Confirm reliable low-current switching on the first article. B3F-5051 is a compatible projected-plunger gold-contact alternative if contact reliability testing warrants a substitution; it is not the selected BOM part. B3F is unsealed/IP00 and cannot be washed. Solder the switches after the SMT cycle, then mount the caps; heating installed caps can deform them.
...
The former reference phone was [iPhone 16 Plus](https://developer.apple.com/download/files/accessories/dimensional-drawings/iphone-16-plus.pdf): 77.76 × 160.89 mm, ring center 80.44 mm from the top, camera keepout ending at 43.72 mm. The widened carrier is now **68.8 × 130.8 mm** in portrait. With the retained ring datum it occupies y=36.905–167.705 mm: **6.815 mm into the camera keepout and 6.815 mm beyond the phone bottom**. This revision therefore fails that nominal phone-fit target. The carrier stays an experimental removable accessory; another mounting position or phone requires a new dimensional check. It is not presented as a confirmed phone-compatible product. Retention, optical clearance, cases and loaded RF remain physical checks; detach for wireless charging.

## Qualification after fabrication

No further user component decisions are required. Build a small engineering batch, then check power and recovery, the exact panel and fold, charging/NTC and pulse loads, purchased button operation, optical support and attached radio behavior. Supplier CAM/assembly review belongs to the prototype order. It does not require delaying digital routing until the user obtains hardware.
