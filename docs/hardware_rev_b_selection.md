...
The nominal fit target is [iPhone 16 Plus](https://developer.apple.com/download/files/accessories/dimensional-drawings/iphone-16-plus.pdf): 77.76 × 160.89 mm; ring center 80.44 mm from the phone top; camera keepout to 43.72 mm. The carrier is **68.8 × 110.8 mm** in portrait, with its ring center 31.5 mm below its top. It occupies y=48.94–159.74 mm: nominal camera gap 5.22 mm and bottom margin 1.15 mm. These are 2D screening values. Cases, optical cones, flash, alignment, retention and phone-loaded RF need physical checks. Carry with the radio end down; detach for wireless charging. The core remains usable without the carrier.
