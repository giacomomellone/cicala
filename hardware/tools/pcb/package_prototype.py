...
EXPORTS = ROOT / 'hardware/rev_a/pcb/exports'
...
def package(date):
    ...
    start = (
        ...
        '- hardware/rev_a/MANUFACTURING.md: exact JLCPCB inputs and order settings.\n'
        '- hardware/rev_a/case/README.md: printing, button-stop adjustment and assembly.\n'
        '- docs/firmware_rev_a.md: toolchain, build, flash, debug and recovery.\n'
        '- hardware/rev_a/REVIEW.md: findings, evidence and prototype acceptance.\n\n'
        'Upload the inner hardware/rev_a/pcb/exports/cicala_rev_a_gerbers.zip\n'
