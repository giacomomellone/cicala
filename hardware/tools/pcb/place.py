...
PCB = REPO + '/hardware/rev_a/pcb/cicala_rev_a.kicad_pcb'
PROJ_FP = REPO + '/hardware/rev_a/pcb/cicala.pretty'
SYS_FP = os.environ.get('KICAD10_FOOTPRINT_DIR',
    '/Applications/KiCad/KiCad.app/Contents/SharedSupport/footprints'
    if sys.platform == 'darwin' else '/usr/share/kicad/footprints')
