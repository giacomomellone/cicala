...
Run tool regressions with the dependencies in `requirements.txt` (NumPy,
Shapely 2 and fontTools):

```sh
python3 -m unittest discover -s hardware/tools/pcb -p 'test_*.py'
```
