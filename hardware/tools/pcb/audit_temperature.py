...
def verify(r35=820000, r36=210000, r37=82500, *, rt=RT):
    ...
    ntc_min = lambda t: resistance(t, rt) * .95 * 36.5e-6
    ntc_max = lambda t: resistance(t, rt) * 1.05 * 39.5e-6
    margins = {
    ...
    allowed = [i / 100 for i in range(6001)
               if nominal_hot < resistance(i / 100, rt) * 38e-6 < nominal_cold]
