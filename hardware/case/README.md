...
![Rev A enclosure CAD](renders/rev_a/assembly.png)
...
The thirteen STL/3MF parts are in `exports/rev_a/`, in millimetres at Z=0.
...
specified in [the BOM](../pcb/BOM.md). Keep the factory PH2 connector intact.
...
board STEP, run `hardware/pcb/tools/export_geom.py` using KiCad Python, then
