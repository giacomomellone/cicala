...
- 20 Rev B helper tests, 54 shared PCB helper tests, 97 product-tool tests and 99 website tests pass. The public website build and strict documentation build pass.
- The device page passes nine viewport/language combinations, with all eight CAD images loaded, both full-resolution PCB PNG links and both silkscreen SVG links checked. PCB views are straight orthographic exports with matching scale. The enclosure export contains 65 native STL/3MF pairs and 60 additional print-oriented pairs, including graded coupons.
