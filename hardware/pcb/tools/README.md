...
| `apply_silkscreen.py` | Native wordmark/service legends and fab references, no copper changes |
...
artwork from `assets/cicala-wordmark.json`; its font source and regeneration
