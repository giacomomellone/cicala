...
The KiCad 10 project is `cicala_rev_a.kicad_pro`. Open the project
...
schematic parity and STEP export. Run `bash hardware/tools/rev_a/export_fab.sh` to
...
The [routing tools](../../tools/pcb/README.md) can produce experimental candidates.
