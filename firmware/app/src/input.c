...
LOG_MODULE_REGISTER(cicala_input, LOG_LEVEL_INF);
...
static void cicala_input_cb(struct input_event *evt, void *user_data)
{
...
INPUT_CALLBACK_DEFINE(NULL, cicala_input_cb, NULL);
