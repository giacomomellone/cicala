...
ZTEST(tk_layout, test_utf8_rejects_malformed_input)
{
    uint32_t cp = 0;
...
ZTEST(tk_layout, test_ligatures_fall_back_to_two_letters)
{
    Glyph out[2];
...
ZTEST(tk_layout, test_unrepresentable_characters_report_themselves)
{
    Glyph out[2];
...
ZTEST(tk_layout, test_text_needing_too_many_lines_is_flagged)
{
...
ZTEST(tk_layout, test_a_full_output_buffer_is_refused)
{
