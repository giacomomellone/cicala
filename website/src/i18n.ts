...
const en = {
  ...
  "info.invite": "Use them as you like.",
  "info.open.start": "The project is",
  "info.open.source": "open source",
  "info.open.middle": ", and anyone can",
  "info.open.contribute": "contribute",
  "info.open.end": " a question.",
  "device.goal":
    "A small e-paper device for the middle of the table. The goal is to bring these questions into a shared object, so you can put your phones away and keep the conversation going.",
...
const de: Record<StringKey, string> = {
  ...
  "info.invite": "Nutzt sie, wie ihr möchtet.",
  "info.open.start": "Das Projekt ist",
  "info.open.source": "Open Source",
  "info.open.middle": ", und alle können",
  "info.open.contribute": "eine Frage beitragen",
  "info.open.end": ".",
  "device.goal":
    "Ein kleines E-Paper-Gerät für die Mitte des Tisches. Die Idee: ein gemeinsamer Gegenstand für diese Fragen, damit ihr die Handys weglegen und im Gespräch bleiben könnt.",
...
const it: Record<StringKey, string> = {
  ...
  "info.invite": "Usatele come volete.",
  "info.open.start": "Il progetto è",
  "info.open.source": "open source",
  "info.open.middle": ", e chiunque può",
  "info.open.contribute": "contribuire",
  "info.open.end": " con una domanda.",
  "device.goal":
    "Un piccolo dispositivo e-paper da mettere al centro del tavolo. L’obiettivo è portare queste domande in un oggetto da condividere, per mettere via i telefoni e continuare la conversazione.",
